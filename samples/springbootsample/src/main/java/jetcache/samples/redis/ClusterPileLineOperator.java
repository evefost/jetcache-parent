 ...
 * @author xieyang
 */
public class ClusterPileLineOperator {

    private static final Logger logger = LoggerFactory.getLogger(ClusterPileLineOperator.class);

    private static JedisPipelineCluster cluster;

    private static ObjectMapper mapper = new ObjectMapper();

    public ClusterPileLineOperator(JedisPipelineCluster cluster) {
    ...
    private static <P, V> Class<V> getTargetType(Type actualValueType) {
