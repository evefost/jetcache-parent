...
public class RedisPipelineConnectionFactory extends JedisConnectionFactory implements BeanFactoryAware {
   ...
   public RedisPipelineConnectionFactory(RedisClusterConfiguration clusterConfig, JedisClientConfiguration clientConfig){
